    ...
    <div>
            ...
            <div className="row g-5">
              ...
              <div className="col-lg-6 wow " data-wow-delay="0.5s">
                <div className="h-100">
                  ...
                  <p>
                    Welcome to Delightful Desserts Bakery, where we bake
                    happiness into every delectable treat we create. From cakes
                    to cookies, each dessert is crafted with care and quality
                    ingredients to bring joy and sweetness to your celebrations
                  ...
                  <div className="row g-2 mb-4">
                    ...
                    <a
                      className="btn btn-warning rounded-pill py-3 px-1 w-50"
                      href=""
                    >
                      Read More
                    </a>
      ...
      <div>
        <div className="container-xxl bg-light my-6 py-6 pt-0">
          <div className="container">
            <div
              className="bg-warning text-light rounded-bottom p-5 my-6 mt-0 wow "
              data-aos="zoom-in"
              data-wow-delay="0.1s"
            >
                    ...
                    >
                      <div className="product-item d-flex flex-column bg-white rounded overflow-hidden h-100">
                        <div className="text-center p-4">
                          ...
                          <h3 className="mb-3">Cake</h3>
                          <span>
                            Tempor erat elitr rebum at clita dolor diam ipsum
